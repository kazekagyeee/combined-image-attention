...
class PipelineConfig:
    ...
    captioner_model: str = "qwen" # qwen/blip/glm/gemma
    ...
    system_prompt: str = ("Первое изображение - полное, второе - выделенная часть полного. "
                          "Опиши то что ты видишь на выделенной части изображения, отталкиваясь от полного, "
    ...
    max_image_size: int = 2500 # Максимальный размер по любой стороне